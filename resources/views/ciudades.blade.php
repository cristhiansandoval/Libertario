...
@section('title', 'Administrar ciudades')
                        ...
                        <div class="box-header">
                            <div class="row">
                                <div class="col-xs-4">
                                  ...
                                  <h3 class="box-title">Tabla de ciudades</h3>
                                </div>
      ...
      <div class="modal-body">
        <form class="form-create" role="form">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Escriba el nombre de la ciudad">
				</div>
			</div>
			<div align="center" style="visibility:hidden">_</div>
      </div>
 ...
 {{-- Modal Form Edit and Delete Post --}}
	<div id="myModal"class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="modal">
					...
					<div class="form-group">
						<label class="control-label col-sm-2"for="title">Descripción:</label>
							<div class="col-sm-10">
							<input type="text" class="form-control" id="descripcion_2" name="descripcion_2" placeholder="Escriba el nuevo nombre de la ciudad">
							</div>
					</div>
					<div align="center" style="visibility:hidden">_</div>
				</form>
			...
			{{-- Form Delete Post --}}
			<div class="deleteContent"> <span class="title">¿Está seguro de eliminar esta ciudad?</span><span class="hidden did"></span>
			</div>
				<div class="modal-footer">
...
<script type="text/javascript">
  ...
  $(document).on('click','.create-modal', function() {
    $('#create').modal('show');
    $('.form-create').show();
    $('.modal-title').text('Añadir Ciudad');
  });
  $("#add").click(function() {
    $.ajaxSetup({
		headers: {
...
$(document).ready(function() {
  $(document).on('click', '.edit-modal', function() {
    ...
    $(document).on('click', '.delete-modal', function() {
        $('.modal-title').text('Eliminar ciudad');
        $('.modal-label').text('');
        $('.modal-body').hide();
        $('.form-create').hide();
